<template>
    <div>
        <GlobalDataTable :value="tiposDeRecebimento" :columns="columns" title="Tipos de Recebimento" dataKey="id" @create="handleCreate" @edit="handleEdit" @delete="handleDelete" @delete-selected="handleDeleteSelected" />
